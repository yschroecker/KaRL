...
def save():
    with tf.device('/cpu:0'):
        with tf.Session() as session:
            ...
            #optimizer._epsilon_tensor = tf.Print(optimizer._epsilon_tensor, [optimizer._epsilon_tensor], message="eps")
